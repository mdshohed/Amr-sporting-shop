      ...
      <Card className=" text-white border border-gray-200 rounded-none p-3 ">
        {/* <Link to={`/all-sporting-goods`}> */}
          ...
          <CardContent className="grid text-gray-700 h-[250px]">
            ...
            <CardTitle className="mt-1 text-2xl font-normal">{item?.name}</CardTitle>
            <p className="text-3xl mt-2 font-medium"><span className="font-light">$</span>{item?.price}</p>
            ...
            <p className="text-sm mt-2"><span className="text-lime-500 font-semibold">Free Delivery </span>from Bangladesh</p>
            
          </CardContent>
          <div className="text-gray-700 px-6">
            <Link to='/' className='btn py-1 px-2 border rounded-2xl hover:border-2 hover:border-lime-500'>View Details</Link>
          </div>
        {/* </Link> */}
