      ...
      <div>
        {products && products?.length ? (
          <div className="grid md:grid-cols-3 gap-4 my-8">
            ...
            <div className="bg-white rounded-md px-4 py-6 mt-[48px] h-max shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
              <ul className="text-gray-800 space-y-4">
                ...
                <li className="flex flex-wrap gap-4 text-sm font-bold">
                  Total{" "}
                  <span className="ml-auto">${grandTotal.toFixed(3)}</span>
                </li>
              </ul>
          ...
          <div className="md:col-span-2 space-y-4 h-[500px] flex justify-center items-center">
            <div className="max-w-4xl mx-auto lg:px-10 py-4 bg-white rounded-lg ">
