            ...
            products.map((product: any, index: number) => (
              ...
              >
                ...
                <div className="ml-auto flex flex-col">
                  ...
                  <h3 className="text-base font-bold text-gray-800 mt-auto">{`$${product?.price} x ${product?.quantity} = $${(product?.price * product?.quantity).toFixed(2)}`}
        ...
        <div className="bg-white rounded-md px-4 py-6 h-max shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
          <ul className="text-gray-800 space-y-4">
            <li className="flex flex-wrap gap-4 text-sm">
              Subtotal <span className="ml-auto font-bold">${totalPrice.toFixed(3)}</span>
            </li>
            <li className="flex flex-wrap gap-4 text-sm">
